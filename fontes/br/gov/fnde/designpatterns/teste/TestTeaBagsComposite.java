//Source file: C:\\ProjetoFNDE\\SISTEMAS\\DesignPatterns\\fontes\\br\\gov\\fnde\\desingpatterns\\teste\\TestTeaBagsComposite.java

package br.gov.fnde.designpatterns.teste;

import br.gov.fnde.designpatterns.structuralpatterns.composite.OneTeaBag;
import br.gov.fnde.designpatterns.structuralpatterns.composite.TeaBags;
import br.gov.fnde.designpatterns.structuralpatterns.composite.TinOfTeaBags;
...
public class TestTeaBagsComposite {
    ...
    public static void main(String[] args) {
       ...
       System.out.println("The smallTinOfTeaBags has " + smallTinOfTeaBags.countTeaBags() + " tea bags in it.");

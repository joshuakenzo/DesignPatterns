//Source file: C:\\ProjetoFNDE\\SISTEMAS\\DesignPatterns\\fontes\\br\\gov\\fnde\\desingpatterns\\behavorialpatterns\\interpreter\\DvdInterpreterClient.java
...
public class DvdInterpreterClient {
    ...
    public String interpret(String expression) {
       ...
       while (expressionTokens.hasMoreTokens())
       {
           ...
           if (currentToken.equals("show")) {continue;}//show in all queries, not really used 
           ...
           else if (currentToken.equals("for")) {forUsed = true;}

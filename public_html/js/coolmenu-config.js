...
oCMenu.barcolor="#000099" //The color of the background bar - Value: "color" alterar cor do menu
oCMenu.barwidth="20" //The width of the background bar. Set this to "menu" if you want it to be the same width as the menu. (this will change to match the border if you have one) - Value: px || "%" || "menu"
...
oCMenu.fromtop=48 //This is the left position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
...
oCMenu.level[0]=new makeCoolMenu() //Add this for each new level
oCMenu.level[0].width=60 //The default width for each level[0] (top) items. You can override this on each item by spesifying the width when making the item. - Value: px || "%"
...
oCMenu.level[0].bgcoloroff="#000099" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
oCMenu.level[0].bgcoloron="#F1DB9F" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
oCMenu.level[0].textcolor="#F1DB9F" //The default text color for each level[0] (top) items. You can override this on each item by spesifying the text color when making the item. - Value: "color"
oCMenu.level[0].hovercolor="#000099" //The default "on" text color for each level[0] (top) items. You can override this on each item by spesifying the "on" text color when making the item. - Value: "color"
...
oCMenu.level[0].bordercolor="#F1DB9F" //The border color for all level[0] (top) items. - Value: "color"
...
oCMenu.level[1]=new makeCoolMenu() //Add this for each new level (adding one to the number)
...
oCMenu.level[2]=new makeCoolMenu() //Add this for each new level (adding one to the number)
oCMenu.level[2].width=150
oCMenu.level[2].height=20
oCMenu.level[2].bgcoloroff="#1C1A99"
oCMenu.level[2].bgcoloron="#F1DB9F"
oCMenu.level[2].textcolor="#F1DB9F" //The default text color for each level[0] (top) items. You can override this on each item by spesifying the text color when making the item. - Value: "color"
oCMenu.level[2].hovercolor="#1C1A99" //The default "on" text color for each level[0] (top) items. You can override this on each item by spesifying the "on" text color when making the item. - Value: "color"
oCMenu.level[2].style="padding:1px; font-family:tahoma,arial,helvetica; font-size:8pt;white-space:nowrap"
...
oCMenu.level[3]=new makeCoolMenu() //Add this for each new level (adding one to the number)
oCMenu.level[3].width=150
oCMenu.level[3].height=20
oCMenu.level[3].bgcoloroff="#1C1A99"
oCMenu.level[3].bgcoloron="#F1DB9F"
oCMenu.level[3].textcolor="#F1DB9F" //The default text color for each level[0] (top) items. You can override this on each item by spesifying the text color when making the item. - Value: "color"
oCMenu.level[3].hovercolor="#1C1A99" //The default "on" text color for each level[0] (top) items. You can override this on each item by spesifying the "on" text color when making the item. - Value: "color"
oCMenu.level[3].style="padding:1px; font-family:tahoma,arial,helvetica; font-size:8pt; white-space:nowrap"
oCMenu.level[3].align="bottom"
oCMenu.level[3].offsetX=0
oCMenu.level[3].offsetY=0
oCMenu.level[3].border=1
oCMenu.level[3].bordercolor="#006699"
...
oCMenu.level[4]=new makeCoolMenu() //Add this for each new level (adding one to the number)
oCMenu.level[4].width=150
oCMenu.level[4].height=20
oCMenu.level[4].bgcoloroff="#1C1A99"
oCMenu.level[4].bgcoloron="#F1DB9F"
oCMenu.level[4].textcolor="#F1DB9F" //The default text color for each level[0] (top) items. You can override this on each item by spesifying the text color when making the item. - Value: "color"
oCMenu.level[4].hovercolor="#1C1A99" //The default "on" text color for each level[0] (top) items. You can override this on each item by spesifying the "on" text color when making the item. - Value: "color"
oCMenu.level[4].style="padding:1px; font-family:tahoma,arial,helvetica; font-size:8pt"
oCMenu.level[4].align="bottom"
oCMenu.level[4].offsetX=0
oCMenu.level[4].offsetY=0
oCMenu.level[4].border=1
oCMenu.level[4].bordercolor="#006699"
oCMenu.level[4].NS4font="tahoma,arial,helvetica"
...
cmTxtColor=''
cmHoverColor=''
cmDisBGColorOn='#000099'
cmDisBGColorOff='#000099'
cmDisTxtColor='#616161'
cmDisHoverColor='#616161'
